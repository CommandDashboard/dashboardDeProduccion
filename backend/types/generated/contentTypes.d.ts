...
export interface ApiBatchBatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ai_status: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_created: Schema.Attribute.Date;
    idBatch: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiDefectDefect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aiConfidence: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defect_type: Schema.Attribute.String;
    description: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    location_x: Schema.Attribute.Decimal;
    location_y: Schema.Attribute.Decimal;
...
export interface ApiMaterialMaterial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    texture_image: Schema.Attribute.Media<
      ...
      true
    >;
    type: Schema.Attribute.Enumeration<['Dekton', 'Silestone', 'Sensa']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPiecePiece extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defects: Schema.Attribute.Relation<'manyToMany', 'api::defect.defect'>;
    dimensions: Schema.Attribute.String;
    idPiece: Schema.Attribute.UID;
    inspection_date: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    surface_brightness: Schema.Attribute.String;
    thickness: Schema.Attribute.String;
    tone_homogeneity: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductionLineProductionLine
  extends Struct.CollectionTypeSchema {
  collectionName: 'production_lines';
  info: {
    displayName: 'production-line';
    pluralName: 'production-lines';
    singularName: 'production-line';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    line_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    plant_location: Schema.Attribute.String;
    process_type: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    stat: Schema.Attribute.Enumeration<['waiting', 'in progress', 'done']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defects_found: Schema.Attribute.Decimal;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::stat.stat'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    total_batches: Schema.Attribute.Integer;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::defect.defect': ApiDefectDefect;
      'api::material.material': ApiMaterialMaterial;
      'api::piece.piece': ApiPiecePiece;
      'api::production-line.production-line': ApiProductionLineProductionLine;
